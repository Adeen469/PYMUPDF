"""
Function: fitz.jm_lineart_clip_stroke_path
Signature: jm_lineart_clip_stroke_path(dev, ctx, path, stroke, ctm, scissor)
Description: No docstring available.
"""

import fitz

# Source code of fitz.jm_lineart_clip_stroke_path:
