"""
Class: fitz.EmptyFileError

Description:
Raised when creating documents from zero-length data.

Inheritance (MRO): EmptyFileError -> FileDataError -> RuntimeError -> Exception -> BaseException -> object

"""

import fitz

# ===== Methods and Attributes of fitz.EmptyFileError =====
